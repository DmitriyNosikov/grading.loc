...
export default function ProductsListItem(): ReactElement {
  return (
    <li className="catalog-item">
      <div className="catalog-item__data">
        ...
        <div className="catalog-item__data-wrapper">
          <a className="link" href="./product.html"><p className="catalog-item__data-title">Электро Гитара Честер bass</p></a>
          <br />
